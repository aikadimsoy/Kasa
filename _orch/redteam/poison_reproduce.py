...
def main() -> int:
    ...
    print("    of one model on one machine, not of the architecture. Measured 2026-08-05 with")
    print("    kasa-agent:8b across two batches of five: 4/5 and 3/5, i.e. 7/10 aggregate — and the")
    print("    naive control was 0/5 and 0/5. n=10 is small; treat it as an existence result with a")
    print("    rough frequency, not an attack success rate for anything else.")

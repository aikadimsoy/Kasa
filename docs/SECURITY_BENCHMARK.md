...
2026-07-09T07:06:47, Windows-11-10.0.26200-SP0, 3.14.5
...
| AUTHZ-DENY | valid token, agent_id='unauthz_512c37', tool profile_read parameters {'scope':'user.name'} | ✅ PASS | critical | `Status code: 403` |
...
| SCAN-SECRETS | Secret Detection with Detect-Secrets | ❌ FAIL | critical | `Total findings: 10; First file with secrets: _orch\redteam\ai_attack_test.py` |
